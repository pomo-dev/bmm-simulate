...
/* package bmm-sim-0.1.0.0 */
#define VERSION_bmm_sim "0.1.0.0"
#define MIN_VERSION_bmm_sim(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "bmm-sim-0.1.0.0"

#define CURRENT_PACKAGE_KEY "bmm-sim-0.1.0.0"
